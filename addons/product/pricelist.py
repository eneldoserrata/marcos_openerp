...
class product_pricelist(osv.osv):
    ...
    def price_get_multi(self, cr, uid, pricelist_ids, products_by_qty_by_partner, context=None):
        ...
        for qty in groups:
            for partner in groups[qty]:
                current_res = self.price_get_batch(cr, uid, pricelist_ids, groups[qty][partner], qty, partner=partner, context=context)
    ...
    def supplier_price_get_multi(self, cr, uid, pricelist_ids, products_by_qty_by_partner, context=None):
    ...
    def supplier_price_get(self, cr, uid, ids, prod_id, qty, partner=None, context=None):
        res_multi = self.supplier_price_get_multi(cr, uid, pricelist_ids=ids, products_by_qty_by_partner=[(prod_id, qty, partner)], context=context)
