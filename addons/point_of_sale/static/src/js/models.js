...
//            var disc = Math.min(Math.max(parseFloat(discount) || 0, 0),100); original
        ...
        export_for_printing: function(){
            return {
                ...
                tax_factor: this.get_tax_factor()
            };
        },
        ...
        get_tax_factor: function(){
            return this.get_all_prices().tax_factor;
        },
    ...
    module.Paymentline = Backbone.Model.extend({
        ...
        export_for_printing: function(){
            return {
                ...
                ipf_payment_type: this.cashregister.get("journal").ipf_payment_type
            };
        },
    });
    ...
    module.Order = Backbone.Model.extend({
        ...
        export_for_printing: function(){
            ...
            return {
                ...
                total_discount: this.getDiscountTotal()*-1, //marcos discount change for ipf,
                change: this.getChange()*-1, //marcos discount change for ipf,
                name : this.getName(),
