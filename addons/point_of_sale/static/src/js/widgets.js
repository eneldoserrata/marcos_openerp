function openerp_pos_widgets(instance, module){ //module is instance.point_of_sale
    ...
    module.NumpadWidget = module.PosBaseWidget.extend({
        ...
        start: function() {
            ...
            jwerty.key('[0-9]', this.clickAppendNewChar, this);

            jwerty.key('num-0', this.clickAppendNewChar, this);
            jwerty.key('num-1', this.clickAppendNewChar, this);
            jwerty.key('num-2', this.clickAppendNewChar, this);
            jwerty.key('num-3', this.clickAppendNewChar, this);
            jwerty.key('num-4', this.clickAppendNewChar, this);
            jwerty.key('num-5', this.clickAppendNewChar, this);
            jwerty.key('num-6', this.clickAppendNewChar, this);
            jwerty.key('num-7', this.clickAppendNewChar, this);
            jwerty.key('num-8', this.clickAppendNewChar, this);
            jwerty.key('num-9', this.clickAppendNewChar, this);
            jwerty.key('num-.', this.clickAppendNewChar, this);

            jwerty.key('.', this.clickAppendNewChar, this);

            jwerty.key('shift+C', this.clickChangeMode, this);
            jwerty.key('shift+D', this.clickChangeMode, this);
            jwerty.key('shift+P', this.clickChangeMode, this);

            jwerty.key('plus', this.clickChangeMode, this);
            jwerty.key('multiply', this.clickChangeMode, this);

            jwerty.key('-', this.clickSwitchSign, this);
            jwerty.key('enter', function(){
                if(event.type === 'keydown' && !$(".searchbox input").is(":focus")){
        ...
        clickSwitchSign: function() {
            ...
            } else if(event.type === 'keydown' && !$("input").is(":focus")){
                return this.state.switchSign();
            } else {
                return true;
            };
        ...
        clickAppendNewChar: function(event) {
            ...
            if (event.type === 'click') {
                ...
                if (event.keyCode === 48 || event.keyCode === 96){
                    ...
                    newChar = '9';
                } else if (event.keyCode === 58 || event.keyCode === 110){
                    newChar = '.'
                };
        ...
        clickChangeMode: function(event) {
            if (event.type === 'click') {
                ...
                if ((event.shiftKey && event.keyCode === 67) || event.keyCode === 107){
                    return this.state.changeMode('quantity');
                } else if(event.shiftKey && event.keyCode === 68){
                    return this.state.changeMode('discount');
                } else if((event.shiftKey && event.keyCode === 80) || event.keyCode === 106){
                    return this.state.changeMode('price');
                }
            } else {
              return true;
            };
